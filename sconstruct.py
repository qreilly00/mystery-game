...
srcFiles = ['main.cpp']
src = [Glob(tmpSrc + '/base/*.cpp'), Glob(tmpSrc + '/basicUtils/*.cpp'), Glob(tmpSrc + '/mapUtils/*.cpp'), Glob(tmpSrc + '/textureUtils/*.cpp'), Glob(tmpSrc + '/hudUtils/*.cpp'), Glob(tmpSrc + '/entity/*.cpp'), Glob(tmpSrc + '/basicShape/*.cpp'), Glob(tmpSrc + '/levelShape/*.cpp')]
